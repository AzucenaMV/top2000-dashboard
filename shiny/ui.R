...
ui <- navbarPage("Top2000",
                 ...
                 fluidRow(
                   column(width = 3,style = "background-color: #E0E0E0;",
                          tags$p(strong("Filters Section", style =  "font-size:25px;color:#585a58")),
                          chooseSliderSkin("Flat"),
                          setSliderColor("SteelBlue",1),
                          tags$p(strong("Years:", style = "font-size:18px;color:#585a58")),
                          div(style = "margin-top: -13px"),
                          tagList(
                            tags$style(type = 'text/css', '#years_slider .irs-grid-text {font-size: 15px; color:#585a58}",
                                       #years_slider .irs-grid-pol {background:#585a58}'), 
                            div(id = 'years_slider',
                            sliderInput("years", NULL, sep= "",
                                        min = 1999, max = 2021, value = c(1999,2021), width = "100%", step = 5)
                            ),
                            #tags$p(strong("Positions:", style = "font-size:18px;color:#585a58")),
                            #div(style = "margin-top: -13px"),
                            #div(id = 'top_slider',
                            #    sliderInput("top", NULL, sep= "",
                            #                min = 10, max = 2000, value = c(0,2000), width = "100%", step = 5)
                            #)
                          ),
                          br(),
                          tags$p(strong("Songs by Times of Occurrence", style = "font-size:18px;color:#585a58")),
                          div(style = "margin-top: -14px"),
                          plotlyOutput("artist_ocurrance_plot", height = 300),
                          br(),
                          tags$p(strong("Songs by Released Decade", style = "font-size:18px;color:#585a58")),
                          div(style = "margin-top: -12px"),
                          plotlyOutput("released_decade",height = 300),
                          br(),
                          ),
